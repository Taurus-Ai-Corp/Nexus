...
class HubSpotConnector:
    ...
    def __init__(self, config: HubSpotConfig | None = None):
    ...
    async def create_contact(
        ...
        phone: str | None = None,
        bizflow_client_id: str | None = None,
    ...
    async def get_contact(self, hubspot_id: str) -> dict[str, Any] | None:
