...
User Reporting System
    ...
    def get_report(self, report_id):
        ...
        if report:
            ...
            report_dict = dict(zip(columns, report, strict=False))
            ...
            report_dict['diagnostics'] = [dict(zip(diagnostic_columns, diag, strict=False)) for diag in diagnostics]
            ...
            report_dict['comments'] = [dict(zip(comment_columns, comment, strict=False)) for comment in comments]
    ...
    def get_all_reports(self, status=None, limit=50):
        ...
        conn.close()
        return [dict(zip(columns, report, strict=False)) for report in reports]
