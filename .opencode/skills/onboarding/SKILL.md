...
>
> - **Validate:** `/merge-unified:integration-validator` — diagnostic checks on API key, account_token, sync status
> - **Full Merge Link** (all 4 endpoints, database schema, production frontend): `/merge-unified:implementing-link`
> - **Automated data syncing** (polling or webhooks, incremental fetches): `/merge-unified:implementing-sync`
> - **Post-connection** (settings page, sync status, relink, custom fields): `/merge-unified:implementing-post-connection`
