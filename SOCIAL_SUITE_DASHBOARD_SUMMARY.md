...
2. **Nexus Integration** - Direct access to Meta Business Suite campaign management
3. **Nexus Integration** - Instagram-specific campaign management
4. **Agent Orchestration** - Ability to run Nexus AI agents
...
- **Nexus Campaigns Tab**: Create and manage Meta/Facebook campaigns
- **Nexus Campaigns Tab**: Create and manage Instagram campaigns (story, reel, feed, explore)
- **Agent Orchestration Tab**: Run Nexus SEO agents, Nexus content/design agents, etc.
...
- Structures payloads for Nexus systems

#### Integration Points:
- **Nexus**: Meta Business Suite campaign management via `/api/nexus/*` endpoints
...
3. **Direct Agent Access**: Can trigger your existing Nexus AI agents
...
The platform is now ready for your social media management employee to efficiently handle Meta Business Suite and Instagram campaigns while leveraging your existing Nexus AI agent systems.