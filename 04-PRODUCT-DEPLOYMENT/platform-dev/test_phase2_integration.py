...
def test_phase2_integration():
    ...
    print("   ✅ AutoPay mandate activated")
    ...
    print("   ✅ Consent verification: PASSED")
    ...
    print("   ✅ Data principal access right: EXERCISED")
    ...
    print("   ✅ Invalid Aadhaar format caught")
    ...
    print("   ✅ Insufficient credit limit caught")
