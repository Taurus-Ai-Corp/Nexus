# Nexus — Week 1 KPI Dashboard & Decision Rules
...
The form-fill `Lead` event is shallow. Meta's algo will optimize for whoever clicks fastest, which is NOT who Nexus's curation team approves. To fix this, fire server-side events via the Conversion API:
