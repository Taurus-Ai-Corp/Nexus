...
- **Brand split is documented correctly.** `.hermes/nexus/README.md` states: client-facing = "Nexus by Taurus AI"; legal entity = "TAURUS AI CORP - FZCO". The new NEXUS plans avoid stale NeoSync/BizFlow/NeoVibe references, and the stale plans are archived under `.hermes/archive/2026-04-26-bizflow-neovibe-phase2/`.
