...
class WhatsAppCommunicationAgent(BaseAgent):
    ...
    async def send_message(self, to: str, message: str, workflow_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def send_media(self, to: str, media_url: str, caption: str = "", workflow_id: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def send_sales_pipeline_update(self, client_number: str, update_type: str, details: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            update_messages = {
                "proposal_sent": f"📄 Your proposal has been sent! We'll follow up in 24-48 hours.",
...
def create_whatsapp_communication_agent(config: Optional[Dict[str, Any]] = None) -> WhatsAppCommunicationAgent:
