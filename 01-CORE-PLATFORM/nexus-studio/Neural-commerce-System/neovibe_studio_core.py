...
class NeoVibeStudioCore:
    ...
    async def run_neovibe_studio(self):
        ...
        try:
            ...
            logger.info("🎨 Asset management: Ready")
            logger.info("🤝 Collaboration tools: Active")
    ...
    async def create_project(project_request: ProjectCreateRequest):
        ...
        try:
            ...
            try:
                ...
                if hasattr(project_request, 'model_dump') and callable(project_request.model_dump):
                    project_data = project_request.model_dump()  # type: ignore
                # Try Pydantic v1 method
                elif hasattr(project_request, 'dict') and callable(project_request.dict):
