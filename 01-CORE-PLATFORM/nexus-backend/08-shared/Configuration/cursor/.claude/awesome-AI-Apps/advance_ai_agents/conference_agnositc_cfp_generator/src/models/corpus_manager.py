...
class ConferenceCorpusManager:
    ...
    def _initialize_couchbase(self):
        ...
        try:
            ...
            print("✅ Connected to Couchbase Cloud")
            print(f"   Bucket: {bucket_name}")
            print("   Multi-Collection Setup: talks_*")
    ...
    async def store_conference_corpus(
        ...
        try:
            ...
            try:
                ...
                print("✅ Stored conference metadata")
            except Exception as e:
            ...
            print("🧪 Testing vector search for new data...")
    ...
    async def _test_vector_search_for_conference(self, conference_id: str) -> bool:
        ...
        try:
            ...
            if similar_talks and len(similar_talks) > 0:
                ...
                print("⚠️ Vector search test returned 0 results")
                return False
