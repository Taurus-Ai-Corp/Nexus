    ...
    async def _generate_meta_optimizations(self, keyword_research: dict[str, Any], market: str) -> dict[str, Any]:
        ...
        return {
            "title_tags": {
                ...
                "landing_page": "Transform Your Marketing with AI | 90% Cost Reduction | TaurusAI UAE",
                "dashboard": "Marketing Dashboard | Real-time Analytics | TaurusAI UAE"
            },
            "meta_descriptions": {
                "homepage": "Cut marketing costs by 90% with TaurusAI's AI-powered automation. Authentic content, multi-cultural expertise, real-time intelligence for UAE businesses.",
                "landing_page": "Join 200+ UAE companies saving 90% on marketing costs while achieving 300% better results. AI marketing automation that actually works.",
                "dashboard": "Complete marketing command center with AI automation, real-time analytics, and multi-platform management for UAE businesses."
            },
            "keywords_meta": [
                "AI marketing automation UAE",
...
async def main():
    ...
    print("   • Meta tag optimizations")
    print("   • Content structure optimization")
    print("   • Technical SEO improvements")
    print("   • Local SEO for UAE market")
