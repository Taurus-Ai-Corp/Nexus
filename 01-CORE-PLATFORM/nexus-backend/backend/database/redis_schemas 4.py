...
class RedisCache:
    ...
    async def get_cached_user(self, user_id: str) -> CachedUser | None:
    ...
    async def get_cached_agent(self, agent_name: str) -> CachedAgent | None:
    ...
    async def get_cached_task(self, task_id: str) -> CachedTask | None:
    ...
    async def get_cached_intelligence(self, competitor_name: str, monitoring_type: str) -> CachedIntelligence | None:
    ...
    async def get_cached_alert(self, alert_id: str) -> CachedAlert | None:
