...
def format_rich_post(
    text: str,
    bold_text: list[str] | None = None,
    italic_text: list[str] | None = None,
    bullet_points: list[str] | None = None,
    numbered_list: list[str] | None = None,
...
async def create_post(text: str, title: str | None = None, visibility: str = "PUBLIC", hashtags: list[str] | None = None) -> dict[str, Any]:
...
async def create_url_share(url: str, text: str, title: str | None = None, description: str | None = None, visibility: str = "PUBLIC") -> dict[str, Any]:
