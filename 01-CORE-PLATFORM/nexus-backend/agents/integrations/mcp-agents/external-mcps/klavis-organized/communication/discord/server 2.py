...
async def _make_discord_request(method: str, endpoint: str, json_data: dict | None = None, expect_empty_response: bool = False) -> Any:
    """
...
async def create_text_channel(server_id: str, name: str, category_id: str | None = None, topic: str | None = None) -> dict[str, Any]:
