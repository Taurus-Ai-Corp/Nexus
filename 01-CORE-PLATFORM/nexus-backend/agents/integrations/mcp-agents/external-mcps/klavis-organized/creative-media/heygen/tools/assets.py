...
async def heygen_get_voices(limit: int | None = 20) -> dict[str, Any]:
    """
...
async def heygen_get_voice_locales(limit: int | None = 20) -> dict[str, Any]:
    """
...
async def heygen_list_avatars(limit: int | None = 20) -> dict[str, Any]:
    """
