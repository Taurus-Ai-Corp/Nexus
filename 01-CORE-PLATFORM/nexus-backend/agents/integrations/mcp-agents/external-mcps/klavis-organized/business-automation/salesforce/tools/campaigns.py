...
async def get_campaigns(status: str | None = None, type_filter: str | None = None, limit: int = 50, fields: list[str] | None = None) -> dict[str, Any]:
...
async def get_campaign_by_id(campaign_id: str, fields: list[str] | None = None) -> dict[str, Any]:
...
async def create_campaign(campaign_data: dict[str, Any]) -> dict[str, Any]:
    ...
    logger.info("Executing tool: create_campaign")
    try:
        sf = get_salesforce_conn()
