...
async def get_leads(status: str | None = None, limit: int = 50, fields: list[str] | None = None, name_contains: str | None = None, company_contains: str | None = None, email_contains: str | None = None, industry: str | None = None) -> dict[str, Any]:
...
async def get_lead_by_id(lead_id: str, fields: list[str] | None = None) -> dict[str, Any]:
...
async def create_lead(lead_data: dict[str, Any]) -> dict[str, Any]:
    """Create a new lead."""
    logger.info("Executing tool: create_lead")
    try:
        sf = get_salesforce_conn()
