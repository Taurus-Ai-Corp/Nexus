...
async def get_contacts(account_id: str | None = None, limit: int = 50, fields: list[str] | None = None, name_contains: str | None = None, email_contains: str | None = None, title_contains: str | None = None) -> dict[str, Any]:
...
async def get_contact_by_id(contact_id: str, fields: list[str] | None = None) -> dict[str, Any]:
...
async def create_contact(contact_data: dict[str, Any]) -> dict[str, Any]:
    ...
    logger.info("Executing tool: create_contact")
    try:
        sf = get_salesforce_conn()
