    ...
    async def _generate_sample_data(self, vertical: BusinessVertical, platform: SocialPlatform) -> dict[str, Any]:
        ...
        data_sets = {
            "ecommerce": {
                "vertical": "E-commerce",
                "metric": "revenue",
                "percentage": random.choice(["340", "275", "185", "420"]),
                "timeframe": random.choice(["90 days", "6 months", "4 months"]),
            ...
            "saas": {
                ...
                "hours": random.choice(["35", "45", "50"]),
                "roi": random.choice(["6.8", "7.2", "5.9"])
            },
            "local_business": {
        ...
        try:
            if platform == SocialPlatform.YOUTUBE:
                ...
                script_data = {
                    ...
                    "hook_text": f"What if I told you that {vertical.value} businesses are seeing {random.choice(['300%', '400%', '500%'])} growth using one simple AI trick?",
...
RESULT (20-25s): Real client saw {random.choice(['200%', '300%', '400%'])} growth
...
#AI #Automation #{vertical.value.title()}
    ...
    async def _generate_case_study_data(self, vertical: BusinessVertical) -> dict[str, Any]:
        ...
        return {
            ...
            "timeframe": "90 days",
            "revenue_increase": random.choice(["340", "275", "185"]),
            "conversion_increase": random.choice(["45", "60", "35"]),
            "response_time_reduction": random.choice(["70", "65", "80"]),
            "cost_savings": f"{random.choice(['25000', '35000', '45000'])}",
