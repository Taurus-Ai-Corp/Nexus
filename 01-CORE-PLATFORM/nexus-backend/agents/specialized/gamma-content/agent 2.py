...
class GammaContentAgent(BaseAgent):
    ...
    async def generate_presentation(self, prompt: str, title: Optional[str] = None, style: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def generate_document(self, prompt: str, title: Optional[str] = None, format: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def generate_webpage(self, prompt: str, title: Optional[str] = None, theme: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def generate_social_post(self, prompt: str, platform: Optional[str] = None, tone: Optional[str] = None) -> Dict[str, Any]:
    ...
    async def list_generations(self, limit: int = 20, offset: int = 0, type: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    async def _direct_api_generate(self, content_type: str, prompt: str, title: Optional[str] = None, 
                                   style: Optional[str] = None, platform: Optional[str] = None, 
